...
import com.storyapp.main.MainActivity

class ImagesBannerWidget : AppWidgetProvider() {

    companion object {

        private const val TOAST_ACTION = "com.storyapp.widget.TOAST_ACTION"
        const val EXTRA_ITEM = "com.storyapp.widget.EXTRA_ITEM"
